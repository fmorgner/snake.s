...
static void test_vector_equals_is_true_for_equal_vectors([[maybe_unused]] void ** state)
{
  // Arrange:
...
static void test_vector_equals_is_false_for_unequal_vectors([[maybe_unused]] void ** state)
{
  // Arrange:
  vector_t vector = {.x = 1, .y = 2};
...
static void test_vector_add_correctly_calculates_sum([[maybe_unused]] void ** state)
{
  // Arrange:
  vector_t vector = {.x = 1, .y = 2};
...
static void test_vector_subtract_correctly_calculates_difference([[maybe_unused]] void ** state)
{
  // Arrange:
  vector_t vector = {.x = 1, .y = 2};
  vector_t other = {.x = 3, .y = 4};
...
static void test_vector_subtract_correctly_calculates_difference_all_zero([[maybe_unused]] void ** state)
{
  // Arrange:
...
static void test_vector_subtract_correctly_calculates_difference_all_non_zero([[maybe_unused]] void ** state)
{
  // Arrange:
...
static void test_vector_grid_distance_calculates_difference([[maybe_unused]] void ** state)
{
  // Arrange:
  vector_t vector = {.x = 1, .y = 2};
  vector_t other = {.x = 3, .y = 4};
...
static void test_vector_grid_distance_calculates_difference_all_zero([[maybe_unused]] void ** state)
{
  // Arrange:
  vector_t vector = {.x = 0, .y = 0};
  vector_t other = {.x = 0, .y = 0};
...
int run_vector_tests(void)
{
  struct CMUnitTest const tests[] = {
    ...
    cmocka_unit_test(test_vector_subtract_correctly_calculates_difference_all_zero),
    cmocka_unit_test(test_vector_subtract_correctly_calculates_difference_all_non_zero),
    ...
    cmocka_unit_test(test_vector_grid_distance_calculates_difference_all_zero),
  };
